...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "IQKeyboardManagerSwift",
                 url: "https://github.com/hackiftekhar/IQKeyboardManager.git", from: "6.5.9"),
        ...
        .package(name: "Realm",
                 url: "https://github.com/realm/realm-cocoa.git", from: "10.22.0"),
    ...
    targets: [
        ...
        .target(
            ...
            dependencies: [
                ...
                "JGProgressHUD",
                .product(name: "JKDrawer", package: "JKDrawer"),
                "kCustomAlert",
                "Loaf",
                "SFSymbol",
